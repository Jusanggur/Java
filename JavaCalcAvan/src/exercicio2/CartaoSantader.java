...
public class CartaoSantader implements CartaoCredito {

	private Pessoa titular;
	private String numCartao, digVerificador;
	private String bandeira, validade;

	public CartaoSantader(Pessoa titular, String numCartao, String validade, String bandeira,String digVerificador) {
	...
	public void imprimir() {
		System.out.println("Cartão Santander");
